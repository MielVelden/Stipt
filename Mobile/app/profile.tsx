...
export default function EditProfileScreen() {
  const { profile: globalProfile, setProfile: setGlobalProfile, isLoading: isGlobalLoading } = useUserProfile()

  const [profile, setProfile] = useState<UserProfileRo>(globalProfile || EMPTY_PROFILE)
  const [savedProfile, setSavedProfile] = useState<UserProfileRo>(globalProfile || EMPTY_PROFILE)
  ...
  async function handleSave() {
    ...
    try {
      ...
      setGlobalProfile(updatedProfile) // Sync global context
  ...
  return (
      ...
      >
        ...
        <Button
            variant="default"
            className="mt-6"
            disabled={!isDirty || isSaving || isGlobalLoading}
            onPress={handleSave}
        >

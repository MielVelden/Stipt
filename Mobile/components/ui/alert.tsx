        ...
        <TextClassContext.Provider
            ...
            <View
                ...
                <View className="absolute left-3.5 top-3">
                    <Icon
                        as={icon}
                        className={cn('size-4', variant === 'destructive' && 'text-destructive', variant === 'success' && 'text-green-600', iconClassName)}
                    />
                </View>
                {children}
            </View>
    ...
    return (
        <Text
            className={cn(
                ...
                textClass?.includes('text-green-600') && 'text-green-600/90',
                className
            )}
            {...props}
        />

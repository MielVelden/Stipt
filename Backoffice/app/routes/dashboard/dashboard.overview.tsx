    ...
    <div className="flex items-center gap-2">
      ...
      <span className="tabular-nums text-sm text-muted-foreground">
        ...
        {session.waitlistCount > 0 && (
          <span className="ml-1 text-xs">+{session.waitlistCount} wachtlijst</span>
        )}
      </span>
    </div>
  )
        ...
        <div className="overflow-hidden rounded-lg border">
          <table className="w-full text-sm">
            <thead className="border-b bg-muted/50">
              <tr>
                <th className="px-4 py-3 text-left font-medium text-muted-foreground">Sessie</th>
                <th className="px-4 py-3 text-left font-medium text-muted-foreground">Tijd</th>
                <th className="px-4 py-3 text-left font-medium text-muted-foreground">Ruimte</th>
                <th className="px-4 py-3 text-left font-medium text-muted-foreground">Bezetting</th>
            ...
            <tbody>
              ...
              {displayed.map((session, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-muted-foreground">{session.room.name}</td>
